...
1. 実装が極めて容易
2. $f$ が <span class="dot-text">なんでも</span> 計算可能.
...
$O(h)$ なら、 $h \to 0$ で 誤差は $0$ に収束する. 
ということは $h$ はできるだけ小さくすればどんどん精度が良くなっても良さそう?
...
例) 中心差分 $\dfrac{f(x+h) - f(x-h)}{h}$ は $h_{best} \approx \ \sqrt{\dfrac{\mathstrut 3 \sqrt{2} 
\ \varepsilon}{|f'''(x)|}}$  くらい ? 
...
![w:200](image-7.png)  ![w:200](image-8.png) ![w:200](image-9.png) ![w:200](image-10.png) ![w:200](image-12.png)
